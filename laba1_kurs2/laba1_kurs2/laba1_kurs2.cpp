...
void calculate_z1(double& z1, double m) {
    try {
        ...
        std::cerr << "Исключение: " << e.what() << " Значение: " << e.getValue() << " Код ошибки: " << e.getCode_of_error() << std::endl; // Строка 36
...
void calculate_z2(double& z2, double m) {
    try {
        ...
        std::cerr << "Исключение: " << e.what() << " Значение: " << e.getValue() << " Код ошибки: " << e.getCode_of_error() << std::endl; // Строка 49
